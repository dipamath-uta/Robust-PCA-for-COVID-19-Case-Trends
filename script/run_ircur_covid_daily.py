...
if __name__ == "__main__":
    ...
    run_ircur_on_matrix(
        csv_path="rpca_continent_cases_per100k_matrix.csv",
        out_lowrank_path="daily_continent_cases_per100k_ircur_lowrank.csv",
        out_sparse_path="daily_continent_cases_per100k_ircur_sparse.csv",
    ...
    run_ircur_on_matrix(
        csv_path="rpca_who_cases_per100k_matrix.csv",
        out_lowrank_path="daily_who_cases_per100k_ircur_lowrank.csv",
        out_sparse_path="daily_who_cases_per100k_ircur_sparse.csv",
        rank=2,
        nr=200,
        nc=6,
    )
