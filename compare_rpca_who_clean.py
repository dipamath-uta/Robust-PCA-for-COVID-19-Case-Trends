...
M      = load(os.path.join(BASE, "rpca_who_cases_per100k_matrix.csv"))
L_pcp  = load(os.path.join(BASE, "rpca_who_cases_per100k_lowrank.csv"))
L_irls = load(os.path.join(BASE, "who_cases_per100k_irls_lowrank.csv"))
...
fig.suptitle("WHO regions – PCP vs IRLS RPCA (low-rank trends)", y=1.02, fontsize=14)
plt.tight_layout()
out_png = os.path.join(BASE, "rpca_who_pcp_vs_irls.png")
